...
@section('page-content')
    <div id="content">
        <div class="container-fluid">
            <h3 class="page-title">Lập bảng báo giá</h3>
            <div class="row">
                @include('backend.quotations._info')
                <div class="col-md-9">
                    <div class="widget">
                                    ...
                                    <table class="table table-condensed table-default table-bordered table-hover" name="test">
                                        <thead>
                                            <tr class="active">
                                                ...
                                                <th class="text-center" width="150">ĐTV</th>
                                                <th class="text-center" width="100">Đơn giá</th>
                                                <th class="text-center" width="100">Bảo hành</th>
